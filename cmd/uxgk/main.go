...
import (
	...
	"github.com/yunhailanuxgk/go-uxgk/cmd/utils"
	"github.com/yunhailanuxgk/go-uxgk/console"
	"github.com/yunhailanuxgk/go-uxgk/eth"
	"github.com/yunhailanuxgk/go-uxgk/ethclient"
	"github.com/yunhailanuxgk/go-uxgk/internal/debug"
...
const (
	clientIdentifier = "uxgk" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the UXGK command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2017-2018 The UXGK Author"
...
func uxgk(ctx *cli.Context) error {
