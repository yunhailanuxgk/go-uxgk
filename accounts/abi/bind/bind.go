...
//
// Detailed usage document and tutorial available on the UXGK Wiki page:
// https://github.com/yunhailanuxgk/go-uxgk/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
